...
#define TAPE_QUERY_DEVICE_ERROR_DATA __MSABI_LONG(4)
  ...
  typedef struct _TP_IO TP_IO,*PTP_IO;
    ...
    PVOID GetCurrentFiber(VOID);
    PVOID GetFiberData(VOID);
    __attribute__((always_inline)) struct _TEB *NtCurrentTeb(VOID) { return (struct _TEB *)__readgsqword(FIELD_OFFSET(NT_TIB,Self)); }
    __attribute__((always_inline)) PVOID GetCurrentFiber(VOID) { return(PVOID)__readgsqword(FIELD_OFFSET(NT_TIB,FiberData)); }
    __attribute__((always_inline)) PVOID GetFiberData(VOID) {
      return *(PVOID *)GetCurrentFiber();
    }
#endif /* __x86_64 */
    ...
    PVOID GetCurrentFiber (VOID);
    PVOID GetFiberData (VOID);
    __attribute__((always_inline)) PVOID GetFiberData (VOID) { return *(PVOID *)GetCurrentFiber (); }
#endif /* arm */
